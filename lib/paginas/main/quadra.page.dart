...
class QuadraPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Column(
        children: InfoModel.infoModel.map((_infoModel) =>
          GestureDetector(
            onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (context) => QuadraInfo(_infoModel),)),
            child: Row(
              children: [Expanded(
                child:Align(alignment: Alignment.topLeft, child: (Image.asset(_categoria.foto)), 
                ),
              ),
